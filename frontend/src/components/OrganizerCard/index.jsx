...
const OrganizerCard = ({ name, role, college, image, linkedin, alt }) => {
  ...
  return (
    ...
    >
      <div className="organizer-card__media" aria-label={alt || name || 'Organizer'}>
        {hasImage ? (
      ...
      <div className="organizer-card__content">
        ...
        {college && <p className="organizer-card__organization">{college}</p>}
